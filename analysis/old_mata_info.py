...
class TypeInfo:
    ...
    def get_trait(self) -> Set['TraitInfo']:
        ...
...
class OneNameSpace(NameSpace):
    def add_symbol(self, name: Name, value: 'OneNameSpace'):
        ...

    def find_name(self, name: Name) -> 'OneNameSpace':
        ...
...
class ObjectBind(OneNameSpace):
    ...
    def get_trait(self) -> Set['TraitInfo']:
        return self.typeinfo.get_trait()
...
class FunctionType(ProperType):
    ...
    def get_trait(self) -> Set['TraitInfo']:
        return TypeRef('Function', self.top_level, self.pos)
...
class TraitInfo(ProperType):
    ...
    methods: ClassVar[List[FunctionType]]
...
class Scope(OneNameSpace):
    vars: ClassVar[Dict[Name, ObjectBind]]
    parent: Optional[OneNameSpace]
    child: Optional[OneNameSpace]
...
Context = Union[ModuleMataInfo, FunctionInfo, Scope, ClassInfo, TraitInfo, ObjectBind]
